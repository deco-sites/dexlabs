    ...
    return (
        <aside class="w-full lg:w-[275px] flex flex-col mt-24 lg:mt-0">
            ...
            <div class="h-full lg:h-full w-full -top-52 lg:top-0 left-0 mt-14 absolute lg:relative">
                <div class="bg-primary text-secondary px-5 py-7 gap-6 flex flex-col items-center rounded-2xl sticky top-28 lg:top-[40vh]">
                    <h2 class="text-center font-semibold text-2xl">{floatingButton.title}</h2>
                    <a
                        href={floatingButton.href || ""}
                        class={`font-normal btn font-semibold rounded-full min-h-10 h-10 text-lg text-primary border-none transition-all duration-200 bg-success hover:bg-secondary`}
                    >
                        {floatingButton.text}
                    </a>
                </div>

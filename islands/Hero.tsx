                        ...
                        <div class="flex items-center gap-3 flex-wrap justify-center">
                            {cta?.map((item) => (
                                <a
                                    ...
                                    class={`overflow-hidden font-normal btn btn-primary px-0 font-medium rounded-full min-h-10 h-10 text-lg ${item.outline && "bg-secondary hover:bg-secondary"
                                        }`}
                                >
                                    <div class={`flex flex-col px-4 pb-0.5 relative hover:-translate-y-full transition-transform duration-500 ease-in-out`}>
                                        ...
                                        <span class={`absolute top-full h-full ${item.outline ? 'text-primary' : 'text-secondary'}`}>{item?.text}</span>
                                    </div>
                                </a>
                            ))}
                        </div>

...
export default function Header({
  ...
  return (
    <>
      <div class="h-28"></div>
      <nav class="drawer drawer-end fixed top-0 w-full bg-secondary z-50">
        ...
        <div class="drawer-content container lg:px-0 px-4 flex gap-8 items-center justify-between py-8 max-w-[1378px]">
          ...
          <div class="hidden items-center justify-between lg:flex w-full">
            <div class="flex gap-10 items-center bg-neutral border border-primary rounded-full py-2 pl-4 pr-8">
              <a href="/">
                ...
                {navigation.links.map((link) => (
                  <li>
                    <a
                      ...
                      class="link no-underline hover:bg-primary hover:text-secondary text-primary py-2.5 px-3.5 rounded-full transition duration-200"
                    >
                      {link.label}
                    </a>
                  </li>
            ...
            <ul class="flex gap-3">
              {navigation.buttons?.map((item) => (
                <a
                  ...
                  class={`font-normal btn btn-primary text-secondary font-medium rounded-full min-h-9 h-9 text-lg ${item.outline && "btn-outline"
                    }`}
                >
                  {item?.text}
                </a>

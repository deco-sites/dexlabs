      ...
      <div class="lg:container mx-auto md:max-w-[1440px] text-sm">
        <GlobalDesign>
          <div class="flex flex-col">
            <div class="flex flex-col gap-6 justify-between items-center lg:items-start lg:flex-row">
              ...
              <div class="flex gap-14 justify-center lg:justify-left">
                {links?.map((link) => (
                  <div class="flex flex-col gap-4">
                    <h4 class="font-semibold text-lg font-bold">{link.title}</h4>
                    {link.items?.map((item) => (
                      <a
                        class="block hover:underline link no-underline py-1 text-lg font-normal"
                        href={item.href}
                      >
                        {item.label}
                      </a>
            ...
            <div class="border-primary border-t flex flex-col gap-4 items-center justify-between lg:flex-row lg:items-center ">
              ...
              {madeWith.enable && <div class="flex flex-col gap-4 items-center lg:flex-row lg:gap-6">
                <a
                  href={madeWith?.href}
